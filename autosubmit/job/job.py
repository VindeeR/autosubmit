...
class Job(object):
    ...
    def split_start_date(self, date, split, split_length, split_unit, cal):
        """
        ...
        """
        split_1 = split - 1
        total_months = split_1 * split_length
        result = add_time(date, total_months, split_unit, cal)
        return result

    def split_end_date(self, start_date, split_length, chunk_unit, cal):
        """
        Gets chunk interval end date

        :param start_date: chunk's start date
        :type start_date: datetime.datetime
        :param split_end_date: length of the split_end_date
        :type split_end_date: int
        ...
        :rtype: datetime.datetime
        """
        return add_time(start_date, split_length, chunk_unit, cal)
